...
<head>
	...
	<title>Detail Artikel - KSR PMI Unit UNISKA MAB Banjarmasin</title>
...
<body>
	<div class="container bg-light">
		...
		<div class="logo clearfix">
			<div class="float-left mt-3 mb-3">
				...
				<div class="text float-right">
					<span class="smk">KSR UNISKA MAB BANJARMASIN</span><br>
		...
		<div class="text-white footer">
			2021 © Copyright UKM KSR PMI Unit UNIKSA MAB.
		</div>
	</div>

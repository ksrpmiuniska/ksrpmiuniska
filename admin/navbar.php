	...
	<div class="container">
		<ul class="navbar-nav">
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="<?= $base_url ?>admin/guru/index.php">Data Pembina</a>
					<a class="dropdown-item" href="<?= $base_url ?>admin/siswa/index.php">Data Anggota</a>
					<a class="dropdown-item" href="<?= $base_url ?>admin/ekskul/index.php">Data Kegiatan</a>

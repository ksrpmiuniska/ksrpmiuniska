...
<head>
	...
	<title>Detail Artikel - Anggota KSR PMI Unit UNISKA MAB</title>
...
<body>
	<div class="container bg-light">
		...
		<div class="logo clearfix">
			<div class="float-left mt-3 mb-3">
				...
				<div class="text float-right">
					<span class="smk"> KSR PMI Unit UNISKA MAB</span><br>
		...
		<div class="row p-3">
			<div class="col-md-8">
				<div class="title mb-3">
					Visi,Misi Dan Sejarah UKM KSR PMI Unit UNISKA MAB.
				</div>
				<div class="artikel">
					<?= $visi_misi['visi_misi'] ?>
				</div>
		...
		<div class="text-white footer">
			2021 © Copyright by Anggota KSR PMI Unit UNISKA MAB.
		</div>
	</div>
